...
/**
 *	this class implements a ordered linked list in which nodes are sorted in ascending order
...
public class OrderedList<T> {
	...
	public void write() {
		try {
			...
			FileWriter fWriter = new FileWriter("C:\\Users\\abdul.ziyan_ymediala\\eclipse-workspace\\AlgorithPrograms\\src\\main\\java\\DataStructure\\OrderedListOut.txt");
			String text = "";
			Node temp;
			temp = head;
			while (temp.next != null) {
	...
	private void userinput() throws Exception {
		...
		File file = new File("C:\\Users\\abdul.ziyan_ymediala\\eclipse-workspace\\AlgorithPrograms\\src\\main\\java\\DataStructure\\OrderedList.txt");
		Scanner sc;
		sc = new Scanner(file);
		String str;
		String s = "";
